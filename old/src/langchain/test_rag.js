...
async function getResponse(message) {
  ...
  const standaloneQuestionTemplate =
    "Given a user message, convert it into a concise lookup question. Answering this standalone question should give enough context to accurately respond to the user.\nUser message: {question}";
